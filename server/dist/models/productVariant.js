...
*/
export async function createProductVariants(variantData) {
    try {
        await pool.query(`
...
export async function getProductVariants(productIds) {
...
export function groupVariants(productVariants) {
    const result = productVariants.reduce(function (obj, variant) {
...
export async function getVariantsStockWithLock(variantIds, connection) {
...
export async function updateVariantsStock(variants, connection) {
